...
# from ai_s import AlphaBetaGomokuAI, get_best_action_multiprocess
...
def run_gbd(is_priority):
    ...
    # ai_player.ai = AlphaBetaGomokuAI(1, depth=2)
    ...
    #             get_best_action_multiprocess, (ai_player.ai, gbd.status_matrix.T)
    #         )
    #         pool.close()
    #         pool.join()
