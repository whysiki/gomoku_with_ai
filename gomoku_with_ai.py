...
class  gomoku_with_ai:
    def __init__(self,root,isTKroot = True,params=None):
        ...
        self.UIJsonString = '{"Version": "1.0.0", "UIName": "gomoku_with_ai", "Description": "", "WindowSize": [1000, 720], "WindowPosition": "Center", "WindowHide": false, "WindowResizable": true, "WindowTitle": "gomoku_with_ai", "DarkMode": false, "BorderWidth": 0, "BorderColor": "#ffffff", "DropTitle": false, "DragWindow": true, "MinSize": [0, 0], "TransparentColor": null, "RootTransparency": 255, "ICOFile": null, "WinState": 1, "WinTopMost": false, "BGColor": "#EFEFEF", "GroupList": {}, "WidgetList": [{"Type": "Form", "Index": 1, "AliasName": "Form_1", "BGColor": "#EFEFEF", "Size": [1000, 720], "EventList": {"Load": "Form_1_onLoad"}}, {"Type": "Canvas", "Index": 2, "AliasName": "Canvas_1", "ParentName": "Form_1", "PlaceInfo": [200, 40, 640, 640, "nw", true, true], "Visible": true, "Size": [640, 640], "BGColor": "#ffffff", "Relief": "flat", "ScrollRegion": null}, {"Type": "Button", "Index": 3, "AliasName": "Button_1", "ParentName": "Form_1", "PlaceInfo": [880, 40, 80, 48, "nw", true, false], "Visible": true, "Size": [80, 48], "BGColor": "#48CFAD", "Text": "重新开始", "FGColor": "#000000", "Font": ["Segoe UI", 11, "bold", "roman", 0, 0], "RoundCorner": 30, "Relief": "raised", "EventList": {"Command": "Button_1_onCommand"}}]}'
